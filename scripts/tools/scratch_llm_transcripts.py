...
from codenames.spymasters import LearnedSpymaster
...
def main():
    ...
    spymaster = LearnedSpymaster("cache/m9/checkpoints/noise_0_08/scorer_best.pt")
    guesser = LLMGuesser()
    ...
    for seed in range(5):
        ...
        result = play_two_team_game(board, (spymaster, guesser), (spymaster, guesser), sims, max_turns=DEFAULT_MAX_TURNS)
